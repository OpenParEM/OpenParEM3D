...
//      ParGridFunction *gridImHz=nullptr;
   ...
   public:
      ...
      void build_PEC_dofs ();
      bool build_A (BoundaryDatabase *, MaterialDatabase *, double, PWConstCoefficient *, PWConstCoefficient *, PWConstCoefficient *);
      void build_P ();
      ...
      bool solve (BoundaryDatabase *, MaterialDatabase *, double, PWConstCoefficient *, PWConstCoefficient *,
                  PWConstCoefficient *, PWConstCoefficient *, int);
      void calculateMeshErrors (struct projectData *, BoundaryDatabase *, PWConstCoefficient *);
      void refineMesh ();
